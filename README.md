...
## Create your own map
If you want to create your own map and try a simulation, you can refer to the document [PLANET DONUT](Documentation/PLANET DONUT) page 8 wich details how to write the .txt file.
